!(function(t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(e)
      : ((t.prettierPlugins = t.prettierPlugins || {}), (t.prettierPlugins.babylon = e()))
})(this, function() {
  'use strict'
  var t = function(t, e) {
    ...
    o = s(function(t, e) {
      ...
      function y(t) {
        ...
        t = t
          ...
          .replace(h, '')
          .replace(m, '$1')
        for (var i = ''; i !== t; ) (i = t), (t = t.replace(d, ''.concat(e, '$1 $2').concat(e)))
        ...
        for (
          ...
          var x = n[2].replace(l, '')
          'string' == typeof c[n[1]] || Array.isArray(c[n[1]])
            ? (c[n[1]] = [].concat(c[n[1]], x))
            : (c[n[1]] = x)
        }
        return { comments: y, pragmas: c }
      }
      function x(t, e) {
  ...
  var c = {
      locStart: function t(e) {
        return e.declaration && e.declaration.decorators && e.declaration.decorators.length > 0
    ...
    l = s(function(t, e) {
      ...
      var r = !0,
        ...
        h = {
          ...
          relational: new o('</>', 7),
          bitShift: new o('<</>>', 8),
          plusMin: new a('+/-', { beforeExpr: r, binop: 9, prefix: !0, startsExpr: !0 }),
          modulo: new o('%', 10),
          star: new o('*', 10),
          slash: new o('/', 10),
          exponent: new a('**', { beforeExpr: r, binop: 11, rightAssociative: !0 })
        },
        p = {
          break: new n('break'),
          ...
          typeof: new n('typeof', { beforeExpr: r, prefix: !0, startsExpr: !0 }),
      ...
      function b(t) {
        return t < 65
          ...
          : t <= 90 ||
              (t < 97
                ? 95 === t
                : t <= 122 || (t <= 65535 ? t >= 170 && y.test(String.fromCharCode(t)) : g(t, v)))
      }
      function T(t) {
        return t < 48
          ? 36 === t
              ...
              (!(t < 65) &&
                (t <= 90 ||
                  (t < 97
                    ...
                    : t <= 122 ||
                      (t <= 65535
                        ? t >= 170 && x.test(String.fromCharCode(t))
                        : g(t, v) || g(t, P)))))
      }
      var w = [
        'any',
      ...
      ;(h.parenR.updateContext = h.braceR.updateContext = function() {
        if (1 !== this.state.context.length) {
          ...
          t === D.braceStatement && this.curContext() === D.functionExpression
        ...
        (h.name.updateContext = function(t) {
          'of' !== this.state.value || this.curContext() !== D.parenStatement
            ? ((this.state.exprAllowed = !1),
              (t !== h._let && t !== h._const && t !== h._var) ||
                (S.test(this.input.slice(this.state.end)) && (this.state.exprAllowed = !0)),
              this.state.isIterator && (this.state.isIterator = !1))
            : (this.state.exprAllowed = !t.beforeExpr)
        }),
        (h.braceL.updateContext = function(t) {
          this.state.context.push(this.braceIsBlock(t) ? D.braceStatement : D.braceExpression),
            (this.state.exprAllowed = !0)
        }),
        ...
        (h._function.updateContext = function(t) {
      ...
      ;(D.j_oTag = new M('<tag', !1)),
        (D.j_cTag = new M('</tag', !1)),
        (D.j_expr = new M('<tag>...</tag>', !0, !0)),
        ...
        (h.jsxTagEnd.updateContext = function(t) {
          ...
          ;(e === D.j_oTag && t === h.slash) || e === D.j_cTag
            ? (this.state.context.pop(), (this.state.exprAllowed = this.curContext() === D.j_expr))
            : (this.state.exprAllowed = !0)
        })
      var B = {
        sourceType: 'script',
      ...
      var K = (function(t) {
            ...
            return (
              ...
              (s.processComment = function(t) {
                if (!('Program' === t.type && t.body.length > 0)) {
                  ...
                  for (
                    n.length > 0 && V(n).start >= t.start && (e = n.pop());
                    n.length > 0 && V(n).start >= t.start;
                  ...
                  if ((!s && e && (s = e), e && this.state.leadingComments.length > 0)) {
                    ...
                    if ('ObjectProperty' === e.type) {
                      ...
                      p &&
                        ...
                        this.state.leadingComments.length > 0 &&
                        ((p.trailingComments = this.state.leadingComments),
                        (this.state.leadingComments = []))
                    }
                  }
                  if (s) {
                    if (s.leadingComments)
                      if (
                        ...
                        V(s.leadingComments).end <= t.start
                      )
                        (t.leadingComments = s.leadingComments), delete s.leadingComments
                      else
                    ...
                    if (V(this.state.leadingComments).end <= t.start) {
                      ...
                      c.length && (t.leadingComments = c),
                        0 === (i = this.state.leadingComments.slice(r)).length && (i = null)
                    }
                  ;(this.state.commentPreviousNode = t),
                    i &&
                      (i.length && i[0].start >= t.start && V(i).end <= t.end
                        ? (t.innerComments = i)
        ...
        J = { bin: [48, 49] }
      ;(J.oct = J.bin.concat([50, 51, 52, 53, 54, 55])),
        (J.dec = J.oct.concat([56, 57])),
        (J.hex = J.dec.concat([65, 66, 67, 68, 69, 70, 97, 98, 99, 100, 101, 102]))
      function H(t) {
        return t <= 65535
      ...
      var z = (function(t) {
          ...
          return (
            ...
            (s.unexpected = function(t, e) {
              ...
              'string' != typeof e && (e = 'Unexpected token, expected "' + e.label + '"'),
          ...
          (function(t) {
            function e(e, s) {
              var i
              return (
                ((i = t.call(this) || this).state = new W()),
                i.state.init(e, s),
                (i.isLookahead = !1),
                i
              )
            ...
            return (
                  ...
                  this.state.tokens.push(
                    new function(t) {
                      ;(this.type = t.type),
                        ...
                        (this.start = t.start),
                        (this.end = t.end),
                        (this.loc = new U(t.startLoc, t.endLoc))
                    }(this.state)),
              ...
              (s.fullCharCodeAtPos = function() {
                ...
                return t <= 55295 || t >= 57344
                  ? t
                  : (t << 10) + this.input.charCodeAt(this.state.pos + 1) - 56613888
              }),
              ...
              (s.skipBlockComment = function() {
                ...
                for (
                  -1 === i && this.raise(this.state.pos - 2, 'Unterminated comment'),
                    this.state.pos = i + 2,
                    I.lastIndex = s;
                  (t = I.exec(this.input)) && t.index < this.state.pos;
                ...
                t: for (; this.state.pos < this.input.length; ) {
                  ...
                  switch (t) {
                    ...
                    case 47:
                      ...
                      break
                    default:
                      if (!((t > 8 && t < 14) || (t >= 5760 && O.test(String.fromCharCode(t)))))
                        break t
                      ++this.state.pos
                  }
                }
              ...
              (s.readToken_mult_modulo = function(t) {
                ...
                42 === t &&
                  42 === i &&
                  (s++, (i = this.input.charCodeAt(this.state.pos + 2)), (e = h.exponent)),
                  61 !== i || r || (s++, (e = h.assign)),
                  this.finishOp(e, s)
              }),
              ...
              (s.readToken_plus_min = function(t) {
                ...
                if (e === t)
                  return 45 === e &&
                    ...
                    S.test(this.input.slice(this.state.lastTokEnd, this.state.pos))
              ...
              (s.readToken_lt_gt = function(t) {
                var e = this.input.charCodeAt(this.state.pos + 1),
                  s = 1
                return e === t
                  ? ((s = 62 === t && 62 === this.input.charCodeAt(this.state.pos + 2) ? 3 : 2),
              ...
              (s.readInt = function(t, e) {
                for (
                  var s = this.state.pos,
                    i = 16 === t ? X.hex : X.decBinOct,
                    r = 16 === t ? J.hex : 10 === t ? J.dec : 8 === t ? J.oct : J.bin,
                    a = 0,
                    n = 0,
                    o = null == e ? 1 / 0 : e;
                  n < o;
                  ...
                  if (this.hasPlugin('numericSeparator')) {
                    ...
                    if (95 === h) {
                      ;-1 === r.indexOf(l) &&
                        ...
                        (i.indexOf(c) > -1 || i.indexOf(l) > -1 || Number.isNaN(l)) &&
                          this.raise(this.state.pos, 'Invalid or unexpected token'),
                        ++this.state.pos
                      continue
                    }
                  ...
                  if (
                    (p = h >= 97 ? h - 97 + 10 : h >= 65 ? h - 65 + 10 : G(h) ? h - 48 : 1 / 0) >= t
                  )
                    break
              ...
              (s.readRadixNumber = function(t) {
                ...
                if (
                  (null == i && this.raise(this.state.start + 2, 'Expected number in radix ' + t),
              ...
              (s.readNumber = function(t) {
                ...
                r
                  ? this.finishToken(h.bigint, o)
                  : (i
                      ? (n = parseFloat(o))
                      : s && 1 !== o.length
                        ? this.state.strict
                          ? this.raise(e, 'Invalid number')
                          : (n = /[89]/.test(o) ? parseInt(o, 10) : parseInt(o, 8))
                        : (n = parseInt(o, 10)),
              ...
              (s.readTmplToken = function() {
                for (var t = '', e = this.state.pos, s = !1; ; ) {
                  ...
                  if (96 === i || (36 === i && 123 === this.input.charCodeAt(this.state.pos + 1)))
                    return this.state.pos === this.state.start && this.match(h.template)
                      ? 36 === i
                        ? ((this.state.pos += 2), void this.finishToken(h.dollarBraceL))
              ...
              (s.readWord1 = function() {
                ...
                for (var t = '', e = !0, s = this.state.pos; this.state.pos < this.input.length; ) {
                  ...
                  if (T(i)) this.state.pos += i <= 65535 ? 1 : 2
                    ...
                    ;(e ? b : T)(a, !0) || this.raise(r, 'Invalid Unicode escape'),
                      (t += H(a)),
                      (s = this.state.pos)
                  }
                  e = !1
              ...
              (s.braceIsBlock = function(t) {
                ...
                return t === h._return
                  ? S.test(this.input.slice(this.state.lastTokEnd, this.state.start))
                  : t === h._else ||
                      t === h.semi ||
                      t === h.eof ||
                      t === h.parenR ||
                      (t === h.braceL
                        ? this.curContext() === D.braceStatement
          ...
          (function(t) {
            ...
            return (
              ...
              (s.parseStatement = function(t, e) {
                return (
                  this.match(h.at) && this.parseDecorators(!0), this.parseStatementContent(t, e))
              }),
                ...
                switch (s) {
                  ...
                  case h._import:
                    ...
                    return (
                      ...
                      this.next(),
                      s == h._import
                        ? 'ImportDeclaration' !== (r = this.parseImport(i)).type ||
                          (r.importKind && 'value' !== r.importKind) ||
                          (this.sawUnambiguousESM = !0)
                        : (('ExportNamedDeclaration' !== (r = this.parseExport(i)).type ||
                  ...
                  case h.name:
                    if (this.isContextual('async')) {
                      ...
                      if ((this.next(), this.match(h._function) && !this.canInsertSemicolon()))
                        return this.expect(h._function), this.parseFunction(i, !0, !1, !0)
                      this.state = n
                    }
                }
                var o = this.state.value,
                  p = this.parseExpression()
                return s === h.name && 'Identifier' === p.type && this.eat(h.colon)
                  ? this.parseLabeledStatement(i, o, p)
                  : this.parseExpressionStatement(i, p)
              }),
              ...
              (s.parseDecorator = function() {
                ...
                if ((this.next(), this.hasPlugin('decorators'))) {
                  ...
                  if (this.eat(h.parenL)) (e = this.parseExpression()), this.expect(h.parenR)
                  else
                  ...
                  if (this.eat(h.parenL)) {
                    ...
                    ;(a.callee = e),
                      (a.arguments = this.parseCallExpressionArguments(h.parenR, !1)),
                      this.toReferencedList(a.arguments),
                      (e = this.finishNode(a, 'CallExpression'))
                  }
                  ;(t.expression = e), this.state.decoratorStack.pop()
              ...
              (s.parseForStatement = function(t) {
                ...
                if (
                  (this.state.inAsync &&
                    ...
                    (this.expectPlugin('asyncGenerators'), (e = !0), this.next()),
                ...
                if (this.match(h._var) || this.match(h._let) || this.match(h._const)) {
                  ...
                  if (
                    ...
                    (this.match(h._in) || this.isContextual('of')) && 1 === s.declarations.length)
                  ) {
                ...
                if (this.match(h._in) || this.isContextual('of')) {
                  ...
                  return (
                    this.toAssignable(o, void 0, p),
                    this.checkLVal(o, void 0, void 0, p),
                    this.parseForIn(t, o, e))
                }
                return (
                  n.start && this.unexpected(n.start), e && this.unexpected(), this.parseFor(t, o))
              }),
              ...
              (s.parseIfStatement = function(t) {
                return (
                  ...
                  (t.alternate = this.eat(h._else) ? this.parseStatement(!1) : null),
                  ...
                  if (this.match(h._case) || this.match(h._default)) {
                    ...
                    e && this.finishNode(e, 'SwitchCase'),
                      ...
                      r
                        ...
                        : (s && this.raise(this.state.lastTokStart, 'Multiple default clauses'),
                          (s = !0),
                          (e.test = null)),
                      this.expect(h.colon)
              ...
              (s.parseLabeledStatement = function(t, e, s) {
                ...
                for (
                  var a = this.state.type.isLoop ? 'loop' : this.match(h._switch) ? 'switch' : null,
                ...
                return (
                  this.state.labels.push({ name: e, kind: a, statementStart: this.state.start }),
              ...
              (s.parseExpressionStatement = function(t, e) {
                return (
                  (t.expression = e), this.semicolon(), this.finishNode(t, 'ExpressionStatement'))
              }),
              ...
              (s.parseFor = function(t, e) {
                return (
                  ...
                  this.expect(h.semi),
                  (t.update = this.match(h.parenR) ? null : this.parseExpression()),
                ...
                for (t.kind = s.keyword; ; ) {
                  ...
                  if (
                    ...
                    this.eat(h.eq)
                      ...
                      : (s !== h._const || this.match(h._in) || this.isContextual('of')
                          ? 'Identifier' === r.id.type ||
                            (e && (this.match(h._in) || this.isContextual('of'))) ||
                            this.raise(
              ...
              (s.parseFunction = function(t, e, s, i, r) {
                ...
                return (
                  ...
                  this.match(h.star) &&
                    ...
                    (t.generator = !0),
                    this.next()),
                  !e || r || this.match(h.name) || this.match(h._yield) || this.unexpected(),
                  e || (this.state.inGenerator = t.generator),
              ...
              (s.parseClassBody = function(t) {
                ...
                for (r.body = [], this.expect(h.braceL); !this.eat(h.braceR); )
                  if (this.eat(h.semi))
                    ...
                    i.length &&
                      ((a.decorators = i), this.resetStartLocationFromNode(a, i[0]), (i = [])),
                      this.parseClassMember(r, a, s),
                      'constructor' === a.kind &&
                        a.decorators &&
              ...
              (s.parseClassMemberWithIsStatic = function(t, e, s, i) {
                ...
                if (((e.static = i), this.eat(h.star)))
                  return (
                    (p.kind = 'method'),
                    this.parseClassPropertyName(p),
                    'PrivateName' === p.key.type
                      ? void this.pushClassPrivateMethod(t, a, !0, !1)
                      : (this.isNonstaticConstructor(r) &&
                          this.raise(r.key.start, "Constructor can't be a generator"),
                ...
                if ((this.parsePostMemberNameModifiers(c), this.isClassMethod())) {
                  ...
                  f &&
                    ((r.kind = 'constructor'),
                    r.decorators &&
                      this.raise(r.start, "You can't attach decorators to a class constructor"),
                    s.hadConstructor &&
                      !this.hasPlugin('typescript') &&
                      this.raise(l.start, 'Duplicate constructor in the same class'),
                    (s.hadConstructor = !0)),
                    this.pushClassMethod(t, r, !1, !1, f)
                } else if (this.isClassProperty())
                  u ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n)
                  ...
                  m && (this.expectPlugin('asyncGenerators'), this.next()),
                    ...
                    'PrivateName' === p.key.type
                      ...
                      : (this.isNonstaticConstructor(r) &&
                          this.raise(r.key.start, "Constructor can't be an async function"),
              ...
              (s.parseClassPropertyName = function(t) {
                ...
                return (
                  t.computed ||
                    ...
                    this.raise(e.start, 'Classes may not have static property named prototype'),
                  'PrivateName' === e.type &&
              ...
              (s.pushClassPrivateMethod = function(t, e, s, i) {
                this.expectPlugin('classPrivateMethods', e.key.start),
                  t.body.push(this.parseMethod(e, s, i, !1, 'ClassPrivateMethod'))
              }),
              ...
              (s.parseExport = function(t) {
                if (this.shouldParseExportStar()) {
                  ...
                  if (
                    ((t.specifiers = s), this.match(h.comma) && this.lookahead().type === h.star)
                  ) {
                    this.expect(h.comma)
                  ...
                  if (this.shouldParseExportDeclaration()) {
                    if (this.isContextual('async')) {
                      ...
                      r.type !== h._function &&
                        this.unexpected(r.start, 'Unexpected token, expected "function"')
                    }
                    ;(t.specifiers = []),
                      (t.source = null),
              ...
              (s.parseExportDefaultExpression = function() {
                ...
                if (this.isContextual('async') && this.lookahead().type === h._function)
                  return (
                    this.eatContextual('async'),
                    this.eat(h._function),
                    this.parseFunction(t, !0, !1, !0, !0))
                ...
                if (this.match(h._let) || this.match(h._const) || this.match(h._var))
                  return this.raise(
                    this.state.start,
              ...
              (s.parseExportFrom = function(t, e) {
                this.eatContextual('from')
                  ? ((t.source = this.match(h.string) ? this.parseExprAtom() : this.unexpected()),
                    this.checkExport(t))
                  : e
                    ? this.unexpected()
                    : (t.source = null),
              ...
              (s.parseExportStar = function(t) {
                this.expect(h.star),
                  this.isContextual('as')
                    ...
                    : (this.parseExportFrom(t, !0), this.finishNode(t, 'ExportAllDeclaration'))
              }),
              ...
              return (
                (s.checkPropClash = function(t, e) {
                  if (!t.computed && !t.kind) {
                    var s = t.key
                    '__proto__' === ('Identifier' === s.type ? s.name : String(s.value)) &&
                      (e.proto && this.raise(s.start, 'Redefinition of __proto__ property'),
                      (e.proto = !0))
                  }
                }),
                (s.getExpression = function() {
                  ...
                  return (
                    this.match(h.eof) || this.unexpected(), (t.comments = this.state.comments), t
                  )
                }),
                ...
                (s.parseMaybeAssign = function(t, e, s, i) {
                  ...
                  e ? (r = !1) : ((e = { start: 0 }), (r = !0)),
                    (this.match(h.parenL) || this.match(h.name) || this.match(h._yield)) &&
                  ...
                  if ((s && (p = s.call(this, p, a, n)), this.state.type.isAssign)) {
                    ...
                    if (
                      ...
                      ('||=' !== u && '&&=' !== u) || this.expectPlugin('logicalAssignment'),
                      (l.left = this.match(h.eq)
                        ? this.toAssignable(p, void 0, 'assignment expression')
                        : p),
                      (e.start = 0),
                      this.checkLVal(p, void 0, void 0, 'assignment expression'),
                      p.extra && p.extra.parenthesized))
                      'ObjectPattern' === p.type
                        ? (c = '`({a}) = 0` use `({a} = 0)`')
                        : 'ArrayPattern' === p.type && (c = '`([a]) = 0` use `([a] = 0)`'),
                        c &&
                          this.raise(
                            p.start,
                ...
                (s.parseExprOp = function(t, e, s, i, r) {
                  ...
                  if (!(null == a || (r && this.match(h._in))) && a > i) {
                    ...
                    p === h.nullishCoalescing
                      ? this.expectPlugin('nullishCoalescingOperator')
                      : p === h.pipeline && this.expectPlugin('pipelineOperator'),
                      this.next()
                    ...
                    return (
                      (n.right = this.parseExprOp(
                        ...
                        c,
                        l,
                        p.rightAssociative ? a - 1 : a,
                        r
                      )),
                      this.finishNode(
                        n,
                        p === h.logicalOR || p === h.logicalAND || p === h.nullishCoalescing
                          ? 'LogicalExpression'
                          : 'BinaryExpression'
                      ),
                    ...
                    if (
                      ...
                      'Identifier' === i.type
                        ...
                        : 'MemberExpression' === i.type &&
                          ...
                          this.raise(e.start, 'Deleting a private field is not allowed')
                    }
                ...
                (s.parseSubscript = function(t, e, s, i, r) {
                  ...
                  if (this.match(h.questionDot)) {
                    ...
                    if (this.eat(h.parenL)) {
                      ...
                      return (
                        (n.callee = t),
                        (n.arguments = this.parseCallExpressionArguments(h.parenR, o)),
                        (n.optional = !0),
                  ...
                  if (this.eat(h.dot)) {
                    ...
                    return (
                      (p.object = t),
                      (p.property = this.parseMaybePrivateName()),
                      (p.computed = !1),
                      r.optionalChainMember
                        ? ((p.optional = !1), this.finishNode(p, 'OptionalMemberExpression'))
                  ...
                  if (!i && this.match(h.parenL)) {
                    ...
                    var d = { start: -1 }
                    return (
                      (u.arguments = this.parseCallExpressionArguments(h.parenR, l, d)),
                      r.optionalChainMember
                        ? this.finishOptionalCallExpression(u)
                        : this.finishCallExpression(u),
                      l && this.shouldParseAsyncArrow()
                        ? ((r.stop = !0),
                          ...
                          this.parseAsyncArrowFromCallExpression(this.startNodeAt(e, s), u))
                        : (this.toReferencedList(u.arguments), u))
                  }
                ...
                (s.parseExprAtom = function(t) {
                  ...
                  switch (this.state.type) {
                    ...
                    case h._import:
                      return this.lookahead().type === h.dot
                        ...
                        : (this.expectPlugin('dynamicImport'),
                          (e = this.startNode()),
                          this.next(),
                          this.match(h.parenL) || this.unexpected(null, h.parenL),
                          this.finishNode(e, 'Import'))
                    case h._this:
                      return (
                        (e = this.startNode()), this.next(), this.finishNode(e, 'ThisExpression'))
                    case h._yield:
                    ...
                    case h.regexp:
                      ...
                      return (
                        ((e = this.parseLiteral(f.value, 'RegExpLiteral')).pattern = f.pattern),
                        (e.flags = f.flags),
                        e
                      )
                    case h.num:
                ...
                (s.parseFunctionExpression = function() {
                  ...
                  return this.state.inGenerator && this.eat(h.dot)
                ...
                (s.parseMetaProperty = function(t, e, s) {
                  ...
                  return (
                    ...
                    (t.property.name !== s || i) &&
                      this.raise(
                        t.property.start,
                        'The only valid meta property for ' + e.name + ' is ' + e.name + '.' + s
                      ),
                ...
                (s.parseParenAndDistinguishExpression = function(t) {
                  ...
                  for (
                    ...
                    if (this.match(h.ellipsis)) {
                      ...
                      ;(n = this.state.start),
                        l.push(this.parseParenItem(this.parseRest(), m, y)),
                        this.match(h.comma) &&
                  ...
                  return (
                    ...
                    l.length > 1
                      ? (((e = this.startNodeAt(p, c)).expressions = l),
                        this.toReferencedList(e.expressions),
                ...
                (s.parseNew = function() {
                  ...
                  if (this.eat(h.dot)) {
                    ...
                    if (!this.state.inFunction && !this.state.inClassProperty) {
                      ...
                      this.hasPlugin('classProperties') && (i += ' or class properties'),
                ...
                (s.parseObj = function(t, e) {
                  ...
                  for (var n = null; !this.eat(h.braceR); ) {
                    ...
                    if (this.match(h.at))
                      ...
                      else for (; this.match(h.at); ) s.push(this.parseDecorator())
                    ...
                    if ((s.length && ((o.decorators = s), (s = [])), this.match(h.ellipsis))) {
                      ...
                      if (null !== n)
                        this.unexpected(n, 'Cannot have multiple rest elements when destructuring')
                      else {
                    ...
                    ;(o.method = !1),
                      (t || e) && ((l = this.state.start), (u = this.state.startLoc)),
                      t || (p = this.eat(h.star))
                    ...
                    if (!t && this.isContextual('async')) {
                      ...
                      this.match(h.comma)
                        ...
                        : ((c = !0),
                          this.match(h.star) &&
                            (this.expectPlugin('asyncGenerators'), this.next(), (p = !0)),
                          this.parsePropertyName(o))
                    } else this.parsePropertyName(o)
                    this.parseObjPropValue(o, l, u, p, c, t, e, f),
                ...
                (s.parseObjPropValue = function(t, e, s, i, r, a, n, o) {
                  var h =
                    this.parseObjectMethod(t, i, r, a, o) || this.parseObjectProperty(t, e, s, a, n)
                  return h || this.unexpected(), h
                }),
                (s.parsePropertyName = function(t) {
                  if (this.eat(h.bracketL))
                    (t.computed = !0), (t.key = this.parseMaybeAssign()), this.expect(h.bracketR)
                  else {
                ...
                (s.parseFunctionBody = function(t, e) {
                  ...
                  if (((this.state.inParameters = !1), (this.state.inAsync = t.async), s))
                ...
                (s.checkFunctionNameAndParams = function(t, e) {
                  ...
                  if ((s && (this.state.strict = s), i)) {
                    ...
                    for (var n = 0, o = t.params; n < o.length; n++) {
                      ...
                      s &&
                        'Identifier' !== h.type &&
                        this.raise(h.start, 'Non-simple parameter in strict mode'),
                ...
                (s.parseIdentifierName = function(t, e) {
                  ...
                  return (
                    !e &&
                      'await' === s &&
                      this.state.inAsync &&
                      this.raise(t, 'invalid use of await inside of an async function'),
                    this.next(),
                    s
                  )
                }),
                (s.checkReservedWord = function(t, e, s, i) {
                  this.state.strict &&
                    (u.strict(t) || (i && u.strictBind(t))) &&
                    this.raise(e, t + ' is a reserved word in strict mode'),
                    this.state.inGenerator &&
                      'yield' === t &&
                      this.raise(e, 'yield is a reserved word inside generator functions'),
                    this.state.inClassProperty &&
                      'arguments' === t &&
                      this.raise(e, "'arguments' is not allowed in class field initializer"),
                ...
                (s.parseYield = function() {
                  ...
                  return (
                    this.state.inParameters &&
                      this.raise(t.start, 'yield is not allowed in generator parameters'),
                    this.state.maybeInArrowParameters &&
                      !this.state.yieldInPossibleArrowParameters &&
                      (this.state.yieldInPossibleArrowParameters = t),
                    this.next(),
                    this.match(h.semi) ||
                    this.canInsertSemicolon() ||
                    (!this.match(h.star) && !this.state.type.startsExpr)
                      ? ((t.delegate = !1), (t.argument = null))
                      : ((t.delegate = this.eat(h.star)), (t.argument = this.parseMaybeAssign())),
              ...
              (function(t) {
                ...
                return (
                  ...
                  (s.toAssignableObjectExpressionProp = function(t, e, s) {
                    if ('ObjectMethod' === t.type) {
                      ...
                      'SpreadElement' !== t.type || s
                        ? this.toAssignable(t, e, 'object destructuring pattern')
                        : this.raise(
                            t.start,
                            'The rest element has to be the last element when destructuring'
                          )
                  ...
                  (s.parseBindingList = function(t, e, s) {
                    for (var i = [], r = !0; !this.eat(t); )
                      if ((r ? (r = !1) : this.expect(h.comma), e && this.match(h.comma)))
                        i.push(null)
                      else {
                        if (this.eat(t)) break
                        if (this.match(h.ellipsis)) {
                          i.push(this.parseAssignableListItemTypes(this.parseRest())),
                            this.expect(t)
                          break
                        }
                        var a = []
                      ...
                      case 'ObjectPattern':
                        for (var a = 0, n = t.properties; a < n.length; a++) {
                          ...
                          'ObjectProperty' === o.type && (o = o.value),
                            this.checkLVal(o, e, s, 'object destructuring pattern')
                        }
                        break
                      case 'ArrayPattern':
                  ...
                  (s.checkToRestConversion = function(t) {
                    ;-1 === ['Identifier', 'MemberExpression'].indexOf(t.argument.type) &&
      ...
      var at = ['minimal']
      function nt(t) {
        if (rt(t, 'decorators') && rt(t, 'decorators-legacy'))
              ...
              return (
                ...
                (s.checkGetterSetterParams = function(t) {
                  ...
                  e.value.params.length !== s &&
                    ('get' === e.kind
                      ? this.raise(i, 'getter must not have any formal parameters')
                      : this.raise(i, 'setter must have exactly one formal parameter')),
                    'set' === e.kind &&
                      'RestElement' === e.value.params[0].type &&
                      this.raise(i, 'setter function argument must not be a rest parameter')
                }),
                ...
                (s.pushClassMethod = function(t, e, s, i, r) {
                  this.parseMethod(e, s, i, r, 'MethodDefinition'),
                    e.typeParameters &&
                      ((e.value.typeParameters = e.typeParameters), delete e.typeParameters),
                    t.body.push(e)
                }),
                ...
                (s.toAssignableObjectExpressionProp = function(e, s, i) {
                  'get' === e.kind || 'set' === e.kind
                    ...
                    : e.method
                      ? this.raise(e.key.start, "Object pattern can't contain methods")
                      : t.prototype.toAssignableObjectExpressionProp.call(this, e, s, i)
                }),
                e
              )
            })(t)
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.jsxReadEntity = function() {
                  for (
                    var t, e = '', s = 0, i = this.input[this.state.pos], r = ++this.state.pos;
                    ...
                    if (';' === (i = this.input[this.state.pos++])) {
                      '#' === e[0]
                        ? 'x' === e[1]
                          ? ((e = e.substr(2)),
                            _.test(e) && (t = String.fromCodePoint(parseInt(e, 16))))
                          : ((e = e.substr(1)),
                            R.test(e) && (t = String.fromCodePoint(parseInt(e, 10))))
                        : (t = k[e])
                      break
                    }
                    e += i
                ...
                (s.jsxParseAttribute = function() {
                  ...
                  return this.eat(h.braceL)
                    ...
                    : ((t.name = this.jsxParseNamespacedName()),
                      (t.value = this.eat(h.eq) ? this.jsxParseAttributeValue() : null),
                ...
                (s.jsxParseClosingElementAt = function(t, e) {
                  var s = this.startNodeAt(t, e)
                  return this.match(h.jsxTagEnd)
                    ? (this.expect(h.jsxTagEnd), this.finishNode(s, 'JSXClosingFragment'))
                    : ((s.name = this.jsxParseElementName()),
                      this.expect(h.jsxTagEnd),
                ...
                (s.jsxParseElementAt = function(t, e) {
                  ...
                  if (!r.selfClosing) {
                    ...
                    j(r) && !j(a)
                      ...
                      : !j(r) && j(a)
                        ? this.raise(
                            a.start,
                            'Expected corresponding JSX closing tag for <' + F(r.name) + '>'
                          )
                        : j(r) ||
                          j(a) ||
                          (F(a.name) !== F(r.name) &&
                  ...
                  return (
                    ...
                    j(r) ? this.finishNode(s, 'JSXFragment') : this.finishNode(s, 'JSXElement'))
                }),
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.flowParsePredicate = function() {
                  ...
                  return (
                    ...
                    (e.line === i.line && e.column === i.column - 1) ||
                      this.raise(s, 'Spaces between ´%´ and ´checks´ are not allowed here.'),
                    this.eat(h.parenL)
                  ...
                  return (
                    this.match(h.modulo)
                      ...
                      : ((e = this.flowParseType()),
                        (this.state.inType = t),
                        this.match(h.modulo) && (s = this.flowParsePredicate())),
                    [e, s]
                  )
                }),
                    ...
                    i.forEach(function(t) {
                      !(function(t) {
                        ...
                        ? 'DeclareModuleExports' === t.type &&
                          (o &&
                            e.unexpected(t.start, 'Duplicate `declare module.exports` statement'),
                          'ES' === n && e.unexpected(t.start, p),
                          (n = 'CommonJS'),
                          (o = !0))
                        : ('CommonJS' === n && e.unexpected(t.start, p), (n = 'ES'))
                    }),
                    (t.kind = n || 'CommonJS'),
                  ...
                  if (
                    ...
                    return (
                      'ExportNamedDeclaration' === (t = this.parseExport(t)).type &&
                        ((t.type = 'ExportDeclaration'), (t.default = !1), delete t.exportKind),
                ...
                (s.flowParseDeclareTypeAlias = function(t) {
                  return (
                    this.next(), this.flowParseTypeAlias(t), this.finishNode(t, 'DeclareTypeAlias'))
                }),
                ...
                (s.flowParseInterfaceish = function(t, e) {
                  ...
                  t.body = this.flowParseObjectType(e, !1, !1, e)
                }),
                ...
                (s.flowParseOpaqueType = function(t, e) {
                  return (
                    ...
                    this.isRelational('<')
                      ...
                      : (t.typeParameters = null),
                    (t.supertype = null),
                    this.match(h.colon) && (t.supertype = this.flowParseTypeInitialiser(h.colon)),
                    (t.impltype = null),
                ...
                (s.flowParseInterfaceType = function() {
                  ...
                  return (
                    (t.body = this.flowParseObjectType(!1, !1, !1, !1)),
                ...
                (s.flowParseObjectTypeMethodish = function(t) {
                  ...
                  return (
                    this.eat(h.ellipsis) && (t.rest = this.flowParseFunctionTypeParam()),
                    this.expect(h.parenR),
                ...
                (s.flowParseObjectType = function(t, e, s, i) {
                  ...
                  for (
                    o.callProperties = [],
                      ...
                      e && this.match(h.braceBarL)
                        ? (this.expect(h.braceBarL), (a = h.braceBarR), (n = !0))
                        : (this.expect(h.braceL), (a = h.braceR), (n = !1)),
                      o.exact = n;
                    !this.match(a);
                    ...
                    if (i && this.isContextual('proto')) {
                      ...
                      u.type !== h.colon &&
                        u.type !== h.question &&
                        (this.next(), (c = this.state.start), (t = !1))
                    }
                    if (t && this.isContextual('static')) {
                      var d = this.lookahead()
                      d.type !== h.colon && d.type !== h.question && (this.next(), (p = !0))
                    }
                    var f = this.flowParseVariance()
                    if (this.eat(h.bracketL))
                      null != c && this.unexpected(c),
                        this.eat(h.bracketL)
                          ? (f && this.unexpected(f.start),
                            o.internalSlots.push(this.flowParseObjectTypeInternalSlot(l, p)))
                          : o.indexers.push(this.flowParseObjectTypeIndexer(l, p, f))
                    else if (this.match(h.parenL) || this.isRelational('<'))
                      null != c && this.unexpected(c),
                        f && this.unexpected(f.start),
                        o.callProperties.push(this.flowParseObjectTypeCallProperty(l, p))
                    else {
                      var m = 'init'
                      if (this.isContextual('get') || this.isContextual('set')) {
                        var y = this.lookahead()
                        ;(y.type !== h.name && y.type !== h.string && y.type !== h.num) ||
                          ((m = this.state.value), this.next())
                      }
                      o.properties.push(this.flowParseObjectTypeProperty(l, p, c, f, m, s))
                    }
                    this.flowObjectTypeSemicolon()
                  }
                  this.expect(a)
                  var x = this.finishNode(o, 'ObjectTypeAnnotation')
                  return (this.state.inType = r), x
                }),
                (s.flowParseObjectTypeProperty = function(t, e, s, i, r, a) {
                  if (this.match(h.ellipsis))
                    return (
                      a ||
                        this.unexpected(
                      ...
                      i && this.unexpected(i.start, 'Spread properties cannot have variance'),
                      this.expect(h.ellipsis),
                  ...
                  return (
                    this.isRelational('<') || this.match(h.parenL)
                      ? ((t.method = !0),
                        ...
                        (t.value = this.flowParseObjectTypeMethodish(
                          this.startNodeAt(t.start, t.loc.start))),
                        ('get' !== r && 'set' !== r) || this.flowCheckGetterSetterParams(t))
                      : ('init' !== r && this.unexpected(),
                        (t.method = !1),
                        this.eat(h.question) && (n = !0),
                        (t.value = this.flowParseTypeInitialiser()),
                        (t.variance = i)),
                    (t.optional = n),
                ...
                (s.flowParseTupleType = function() {
                  ...
                  for (
                    ...
                    (t.types.push(this.flowParseType()), !this.match(h.bracketR));
                ...
                (s.flowParseFunctionTypeParams = function(t) {
                  ...
                  for (var e = null; !this.match(h.parenR) && !this.match(h.ellipsis); )
                    t.push(this.flowParseFunctionTypeParam()),
                      this.match(h.parenR) || this.expect(h.comma)
                  return (
                    this.eat(h.ellipsis) && (e = this.flowParseFunctionTypeParam()),
                    { params: t, rest: e })
                }),
                  ...
                  switch (this.state.type) {
                    case h.name:
                      return this.isContextual('interface')
                        ...
                        : this.flowIdentToTypeAnnotation(s, i, r, this.parseIdentifier())
                    case h.braceL:
                    ...
                    case h.relational:
                      if ('<' === this.state.value)
                        return (
                          (r.typeParameters = this.flowParseTypeParameterDeclaration(!1)),
                          this.expect(h.parenL),
                      ...
                      if (a) {
                        if (
                          ...
                          this.state.noAnonFunctionType ||
                            !(
                              this.match(h.comma) ||
                              (this.match(h.parenR) && this.lookahead().type === h.arrow))))
                ...
                (s.parseConditional = function(e, s, i, r, a) {
                  ...
                  if (a) {
                    ...
                    try {
                      ...
                      if (t instanceof SyntaxError)
                        return (this.state = o), (a.start = t.pos || this.state.start), e
                      throw t
                    }
                  }
                  ...
                  return (
                    ...
                    (l.test = e),
                    (l.consequent = d),
                    (l.alternate = this.forwardNoArrowParamsConversionAt(l, function() {
                ...
                (s.tryParseConditionalConsequent = function() {
                  ...
                  return this.state.noArrowParamsConversionAt.pop(), { consequent: t, failed: e }
                }),
                  ...
                  for (var i = this, r = [e], a = []; 0 !== r.length; ) {
                    ...
                    'ArrowFunctionExpression' === n.type
                      ? (n.typeParameters || !n.returnType
                          ? (this.toAssignableList(n.params, !0, 'arrow function parameters'),
                            t.prototype.checkFunctionNameAndParams.call(this, n, !0))
                          : a.push(n),
                        r.push(n.body))
                ...
                (s.shouldParseExportStar = function() {
                  return (
                    ...
                    (this.isContextual('type') && this.lookahead().type === h.star))
                }),
                ...
                (s.readToken = function(e) {
                  ...
                  return !this.state.inType || (62 !== e && 60 !== e)
                    ? (function(t, e) {
                      ...
                      ? ((this.state.isIterator = !0), t.prototype.readWord.call(this))
                      : t.prototype.readToken.call(this, e)
                    : this.finishOp(h.relational, 1)
                }),
                (s.toAssignable = function(e, s, i) {
                  return 'TypeCastExpression' === e.type
                    ? t.prototype.toAssignable.call(this, this.typeCastToParameter(e), s, i)
                    : t.prototype.toAssignable.call(this, e, s, i)
                }),
                ...
                (s.parseClassProperty = function(e) {
                  return (
                    this.match(h.colon) && (e.typeAnnotation = this.flowParseTypeAnnotation()),
                ...
                (s.pushClassMethod = function(e, s, i, r, a) {
                  s.variance && this.unexpected(s.variance.start),
                    delete s.variance,
                    this.isRelational('<') &&
                      (s.typeParameters = this.flowParseTypeParameterDeclaration(!1)),
                ...
                (s.parseObjPropValue = function(e, s, i, r, a, n, o, p) {
                  ...
                  e.variance && this.unexpected(e.variance.start),
                    ...
                    t.prototype.parseObjPropValue.call(this, e, s, i, r, a, n, o, p),
                ...
                (s.parseAssignableListItemTypes = function(t) {
                  ...
                  return (
                    this.match(h.colon) && (t.typeAnnotation = this.flowParseTypeAnnotation()),
                ...
                (s.parseImportSpecifiers = function(e) {
                  ...
                  if (
                    ...
                    'type' === s && i.type === h.star && this.unexpected(i.start),
                      (E(i) || i.type === h.braceL || i.type === h.star) &&
                ...
                (s.parseImportSpecifier = function(t) {
                  ...
                  if (this.isContextual('as') && !this.isLookaheadContextual('as')) {
                    ...
                    null === r || this.match(h.name) || this.state.type.keyword
                      ? ((e.imported = i),
                        (e.importKind = null),
                        (e.local = this.parseIdentifier()))
                      : ((e.imported = n), (e.importKind = r), (e.local = n.__clone()))
                  } else
                    null !== r && (this.match(h.name) || this.state.type.keyword)
                      ? ((e.imported = this.parseIdentifier(!0)),
                        (e.importKind = r),
                  ...
                  o &&
                    ...
                    (o || p) && this.checkReservedType(e.local.name, e.local.start),
                    !a || o || p || this.checkReservedWord(e.local.name, e.start, !0, !0),
                    this.checkLVal(e.local, !0, void 0, 'import specifier'),
                    t.specifiers.push(this.finishNode(e, 'ImportSpecifier'))
                }),
                  ...
                  if (null != n || this.isRelational('<')) {
                    ...
                    try {
                      ;(c = this.flowParseTypeParameterDeclaration()),
                        ((p = this.forwardNoArrowParamsConversionAt(c, function() {
                ...
                (s.checkFunctionNameAndParams = function(e, s) {
                  if (!s || -1 === this.state.noArrowParamsConversionAt.indexOf(e.start))
                    return t.prototype.checkFunctionNameAndParams.call(this, e, s)
                }),
                ...
                (s.parseSubscript = function(e, s, i, r, a) {
                  if (this.match(h.questionDot) && this.isLookaheadRelational('<')) {
                    if ((this.expectPlugin('optionalChaining'), (a.optionalChainMember = !0), r))
                      return (a.stop = !0), e
                    this.next()
                    ...
                    return (
                      ...
                      this.expect(h.parenL),
                      (n.arguments = this.parseCallExpressionArguments(h.parenR, !1)),
                      (n.optional = !0),
                      this.finishNode(n, 'OptionalCallExpression'))
                  }
                  if (!r && this.shouldParseTypes() && this.isRelational('<')) {
                    ...
                    try {
                      return (
                        ...
                        this.expect(h.parenL),
                        (o.arguments = this.parseCallExpressionArguments(h.parenR, !1)),
                ...
                (s.skipBlockComment = function() {
                  return this.hasPlugin('flow') &&
                    ...
                    : this.hasPlugin('flow') && this.state.hasFlowComment
                      ? (-1 === (e = this.input.indexOf('*-/', (this.state.pos += 2))) &&
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.tsParseBindingListForSignature = function() {
                  ...
                  return this.parseBindingList(h.parenR).map(function(e) {
                    if ('Identifier' !== e.type && 'RestElement' !== e.type)
                      throw t.unexpected(e.start, 'Name in a signature must be an Identifier.')
                    return e
                  })
                }),
                ...
                (s.tsParseSignatureMember = function(t) {
                  var e = this.startNode()
                  return (
                    'TSConstructSignatureDeclaration' === t && this.expect(h._new),
                  ...
                  return (
                    ...
                    this.eat(h.plusMin)
                      ...
                      : (this.isContextual('readonly') && this.next(),
                        !!this.match(h.bracketL) &&
                          (this.next(),
                          !!this.tsIsIdentifier() && (this.next(), this.match(h._in)))))
                }),
                ...
                (s.tsParseMappedType = function() {
                  ...
                  return (
                    ...
                    this.expect(h.bracketR),
                    this.match(h.plusMin)
                      ? ((t.optional = this.state.value), this.next(), this.expect(h.question))
                      : this.eat(h.question) && (t.optional = !0),
                ...
                (s.tsParseInterfaceDeclaration = function(t) {
                  ;(t.id = this.parseIdentifier()),
                    ...
                    this.eat(h._extends) && (t.extends = this.tsParseHeritageClause())
                  var e = this.startNode()
                  return (
                    (e.body = this.tsParseObjectTypeMembers()),
                ...
                (s.tsParseModuleBlock = function() {
                  ...
                  return (
                    this.expect(h.braceL),
                    this.parseBlockOrModuleBlockBody((t.body = []), void 0, !0, h.braceR),
                  ...
                  return (
                    this.isContextual('global')
                      ...
                      : this.match(h.string)
                        ? (t.id = this.parseExprAtom())
                        : this.unexpected(),
                    this.match(h.braceL) ? (t.body = this.tsParseModuleBlock()) : this.semicolon(),
                ...
                (s.tsParseExternalModuleReference = function() {
                  var t = this.startNode()
                  if (
                    (this.expectContextual('require'), this.expect(h.parenL), !this.match(h.string)))
                    throw this.unexpected()
                  return (
                    (t.expression = this.parseLiteral(this.state.value, 'StringLiteral')),
                    this.expect(h.parenR),
                ...
                (s.nodeWithSamePosition = function(t, e) {
                  ...
                  return (
                    ...
                    (s.end = t.end),
                    (s.loc.end = t.loc.end),
                    t.leadingComments && (s.leadingComments = t.leadingComments),
                    t.trailingComments && (s.trailingComments = t.trailingComments),
                ...
                (s.tsTryParseDeclare = function(t) {
                  switch (this.state.type) {
                    ...
                    case h._const:
                      if (this.match(h._const) && this.isLookaheadContextual('enum'))
                        return (
                ...
                (s.tsParseDeclaration = function(t, e, s) {
                  switch (e) {
                    ...
                    case 'interface':
                      if (s || this.match(h.name))
                        return s && this.next(), this.tsParseInterfaceDeclaration(t)
                      break
                    case 'module':
                    ...
                    case 'namespace':
                      if (s || this.match(h.name))
                        return s && this.next(), this.tsParseModuleOrNamespaceDeclaration(t)
                      break
                    case 'type':
                      if (s || this.match(h.name))
                        return s && this.next(), this.tsParseTypeAliasDeclaration(t)
                  }
                }),
                  ...
                  return (
                    (e.params = this.tsInType(function() {
                      return t.tsInNoContext(function() {
                        return (
                          t.expectRelational('<'),
                          t.tsParseDelimitedList('TypeParametersOrArguments', t.tsParseType.bind(t)))
                      })
                    })),
                    (this.state.exprAllowed = !1),
                    this.expectRelational('>'),
                ...
                (s.isExportDefaultSpecifier = function() {
                  return (
                    !this.tsIsDeclarationStart() && t.prototype.isExportDefaultSpecifier.call(this))
                }),
                (s.parseAssignableListItem = function(t, e) {
                  var s,
                    i = !1
                  t &&
                    ((s = this.parseAccessModifier()), (i = !!this.tsParseModifier(['readonly'])))
                ...
                (s.parseFunctionBodyAndFinish = function(e, s, i) {
                  !i &&
                    this.match(h.colon) &&
                    (e.returnType = this.tsParseTypeOrTypePredicateAnnotation(h.colon))
                  var r =
                ...
                (s.parseSubscript = function(e, s, i, r, a) {
                  ...
                  var p = this.tsTryParseAndCatch(function() {
                    if (n.isRelational('<')) {
                      ...
                      o.callee = e
                      var p = n.tsParseTypeArguments()
                      if (p) {
                        if (!r && n.eat(h.parenL))
                          return (
                            (o.arguments = n.parseCallExpressionArguments(h.parenR, !1)),
                            (o.typeParameters = p),
                            n.finishCallExpression(o))
                        if (n.match(h.backQuote))
                          return n.parseTaggedTemplateExpression(s, i, e, a, p)
                      }
                    }
                    n.unexpected()
                  })
                  return p || t.prototype.parseSubscript.call(this, e, s, i, r, a)
                }),
                (s.parseNewArguments = function(e) {
                  var s = this
                ...
                (s.parseExport = function(e) {
                  if (this.match(h._import))
                    return this.expect(h._import), this.tsParseImportEqualsDeclaration(e, !0)
                  if (this.eat(h.eq)) {
                    var s = e
                    return (
                ...
                (s.parseClassMemberWithIsStatic = function(e, s, i, r) {
                  ...
                  if (
                    (h && (a.abstract = !0), p && (o.readonly = !0), !h && !r && !a.accessibility)
                  ) {
                ...
                (s.parseExpressionStatement = function(e, s) {
                  return (
                    ('Identifier' === s.type ? this.tsParseExpressionStatement(e, s) : void 0) ||
                ...
                (s.parseExportDeclaration = function(e) {
                  ...
                  return (
                    this.match(h.name) && (s = this.tsTryParseExportDeclaration()),
                ...
                (s.parseVarHead = function(e) {
                  t.prototype.parseVarHead.call(this, e),
                    'Identifier' === e.id.type && this.eat(h.bang) && (e.definite = !0)
                  var s = this.tsTryParseTypeAnnotation()
                  s && ((e.id.typeAnnotation = s), this.finishNode(e.id, e.id.type))
                }),
                (s.parseAsyncArrowFromCallExpression = function(e, s) {
                  return (
                    this.match(h.colon) && (e.returnType = this.tsParseTypeAnnotation()),
                    t.prototype.parseAsyncArrowFromCallExpression.call(this, e, s))
                }),
                (s.parseMaybeAssign = function() {
                  ...
                  if (this.match(h.jsxTagStart)) {
                    it(this.curContext() === D.j_oTag),
                      it(this.state.context[this.state.context.length - 2] === D.j_expr)
                    var p = this.state.clone()
                    try {
                      var c
                  ...
                  if (void 0 === e && !this.isRelational('<'))
                    return (s = t.prototype.parseMaybeAssign).call.apply(s, [this].concat(n))
                  var l = this.state.clone()
                  try {
                    var u
                    ;(r = this.tsParseTypeParameters()),
                      'ArrowFunctionExpression' !==
                        (i = (u = t.prototype.parseMaybeAssign).call.apply(u, [this].concat(n)))
                    ...
                    return (
                      ...
                      (this.state = l),
                      (d = t.prototype.parseMaybeAssign).call.apply(d, [this].concat(n)))
                  }
                  return (
                    r && 0 !== r.params.length && this.resetStartLocationFromNode(i, r.params[0]),
                    (i.typeParameters = r),
                    i
                  )
                }),
      ...
      ;(e.parse = function(t, e) {
        if (!e || 'unambiguous' !== e.sourceType) return pt(e, t).parse()
        e = Object.assign({}, e)
        try {
          e.sourceType = 'module'
          var s = pt(e, t),
          ...
          try {
            return (e.sourceType = 'script'), pt(e, t).parse()
          } catch (t) {}
          throw s
        }
      }),
  ...
  function d(e, s, i) {
    ...
    try {
      ...
      try {
        r = a[o](e, Object.assign({}, n, { strictMode: !1 }))
      } catch (e) {
        throw t(s.message.replace(/ \(.*\)/, ''), {
          start: { line: s.loc.line, column: s.loc.column + 1 }
        })
      }
    }
  ...
  var m = Object.assign({ parse: d, astFormat: 'estree', hasPragma: u }, c)
  return {
    parsers: {
      babylon: m,
      ...
      'json-stringify': Object.assign(
        {
          parse: function(t, e, s) {
            var i = d(t, 0, Object.assign({}, s, { parser: 'json' }))
